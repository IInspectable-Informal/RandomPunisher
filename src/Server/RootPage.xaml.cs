    ...
    public sealed partial class RootPage : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            try
            {
                ...
                CurApp.RootFolder = await DriveRoot.GetFolderAsync("媒体资源");
                CurApp.JsonFile = await CurApp.RootFolder.GetFileAsync("Punishments.json");
        ...
        private void NavigateBack(object sender, RoutedEventArgs e) { RootFrame.GoBack(); }
        ...
        private async void CloseApp(object sender = null, RoutedEventArgs e = null)
        {
            ...
            if (CurPage == typeof(MainPage)) { await AppView.TryConsolidateAsync(); }
